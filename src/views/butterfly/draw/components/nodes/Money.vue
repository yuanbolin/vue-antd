<template>
  <div @click="clickChildren">
    <svg t="1666864665829" class="icon" viewBox="0 0 1024 1024" version="1.1" xmlns="http://www.w3.org/2000/svg" p-id="1993" width="100" height="100">
      <defs>
